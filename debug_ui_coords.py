...
def analyze_logs():
    ...
    try:
        with open("debug-b53f80.log", "r") as f:
            lines = f.readlines()
        ...
        for line in lines:
            try:
                entry = eval(line.strip())  # Simple JSON-like parsing
        ...
        print("No debug-b53f80.log file found. Run the game first to generate logs.")
