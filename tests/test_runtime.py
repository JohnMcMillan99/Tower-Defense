...
def test_full_game_loop(minimal_mode=False):
    """Test running the full game loop with pygame."""
    print(f"Testing full game loop (minimal_mode={minimal_mode})")
    ...
    try:
        ...
        game = Game(web_mode=False, minimal_mode=minimal_mode)
        print("Game created")
...
def main():
    ...
    success = test_full_game_loop(minimal_mode=False)
